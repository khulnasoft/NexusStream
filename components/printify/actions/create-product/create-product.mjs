    ...
    if (this.imageCount) {
      for (let i = 1; i <= this.imageCount; i++) {
        ...
        props[`imagePath_${i}`] = {
          ...
          description: `The URL or path to a file in the \`/tmp\` directory of the image ${i}. [See the documentation on working with files](https://khulnasoft.com/docs/code/nodejs/working-with-files/#writing-a-file-to-tmp).`,
        };
        props[`imageX_${i}`] = {
          type: "string",
