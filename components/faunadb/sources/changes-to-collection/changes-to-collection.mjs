...
export default {
  ...
  props: {
    ...
    emitEventsInBatch: {
      ...
      description:
        "If `true`, all events are emitted as an array, within a single Nexusstream event. Defaults to `false`, emitting each event in Fauna as its own event in Nexusstream",
      optional: true,
      default: false,
    },
  },
