...
export default {
  ...
  propDefinitions: {
    ...
    attachments: {
      type: "string[]",
      label: "Attachments",
      description: "File paths of files previously downloaded in Nexusstream E.g. (`/tmp/my-image.jpg`). [Download a file to the `/tmp` directory](https://khulnasoft.com/docs/code/nodejs/http-requests/#download-a-file-to-the-tmp-directory)",
      optional: true,
    },
    channelId: {
      type: "string",
