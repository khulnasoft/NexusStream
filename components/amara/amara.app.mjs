...
export default {
  ...
  propDefinitions: {
    ...
    subtitles: {
      type: "string",
      label: "Subtitles",
      description: "The subtitles to submit, as a string, depending on **Subtitles format**. Enter an [expression](https://khulnasoft.com/docs/workflows/steps/params/#entering-expressions) to preserve escape sequences (e.g. `{{\"WEBVTT\\n\\n00:01.000 --> 00:04.000\\nNever drink liquid nitrogen.\\n\\n00:05.000 --> 00:09.000\\n- It will perforate your stomach.\\n- You could die.\"}}`).",
      optional: true,
    },
    subtitlesUrl: {
      type: "string",
