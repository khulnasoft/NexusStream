...
export default {
  ...
  props: {
    ...
    emitEventsInBatch: {
      ...
      description:
        "If `true`, all messages are emitted as an array, within a single Nexusstream event. Defaults to `false`, emitting each Discord message as its own event in Nexusstream",
      optional: true,
      default: false,
    },
    timer: {
