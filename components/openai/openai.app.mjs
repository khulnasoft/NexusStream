  ...
  methods: {
    ...
    _commonHeaders() {
      return {
        ...
        "User-Agent": "@KhulnaSoft/nexusstream v1.0",
      };
    },
    _betaHeaders() {
      return {
