 ...
 * https://khulnasoft.com/docs/data-stores/#supported-data-types
 */
...
export default {
  ...
  propDefinitions: {
    ...
    key: {
      label: "Key",
      type: "string",
      description: "Key for the data you'd like to add or update. Refer to your existing keys [here](https://khulnasoft.com/data-stores/).",
