...
export default {
  ...
  name: "Get Difference",
  description: "Get the difference between two data stores. Result contains key/value pairs where the key exists in one data store, but not the other. [Nexusstream Data Stores](https://khulnasoft.com/data-stores/).",
  version: "0.0.2",
  type: "action",
  props: {
    app,
