...
export default {
  ...
  description: "Get all record keys in your [Nexusstream Data Store](https://khulnasoft.com/data-stores/) that matches with your query. The memory consumption of the workflow can be affected, since this action will be exposing, to the workflow, the entire data from the selected datastore",
  version: "0.0.3",
  type: "action",
  props: {
    app,
