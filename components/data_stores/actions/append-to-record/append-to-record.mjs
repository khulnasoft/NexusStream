...
export default {
  ...
  description: "Append to a record in your data store [Nexusstream Data Store](https://khulnasoft.com/data-stores/). If the record does not exist, a new record will be created in an array format.",
  version: "0.0.2",
  type: "action",
  props: {
    app,
    ...
    key: {
      ...
      description: "Enter a key for the record set you'd like to append to. Refer to your existing keys [here](https://khulnasoft.com/data-stores/).",
    },
    value: {
      propDefinition: [
        app,
