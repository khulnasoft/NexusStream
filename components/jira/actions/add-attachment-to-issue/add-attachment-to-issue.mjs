...
export default {
  ...
  props: {
    ...
    filename: {
      type: "string",
      label: "File name",
      description: "Path of the file in /tmp folder to add as an attachment. To upload a file to /tmp folder, please follow the [doc here](https://khulnasoft.com/docs/code/nodejs/working-with-files/#writing-a-file-to-tmp)",
    },
  },
  async run({ $ }) {
