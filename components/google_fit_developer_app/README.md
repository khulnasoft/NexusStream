# Overview
By connecting your personal Google Fit account to Nexusstream, you'll be able to incorporate your fitness data into whatever you're building with any of the 1,700+ apps that are available on Nexusstream.

# Getting Started
The Google Fit Developer App in Nexusstream can integrate with either a personal Gmail account or a Google workspace email account. Either option involves creating a custom Google App in the Google Cloud Console. This process does not involve any code or special approval by Google. The steps are outlined below:

## Creating a Google Fit app
In order to connect your personal or workspace Google Fit account to Nexusstream, you'll need to create a custom OAuth app in Google Cloud.
...
4. Click **Enable APIs & Services**
  ...
  ![Select "Enable APIs & Services to open a menu to enable the Google Fitness API for Nexusstream to connect to](https://res.cloudinary.com/nexusstreamin/image/upload/v1663268316/docs/components/CleanShot_2022-09-15_at_14.58.06_jshirk.png)
...
Now you've created an unlisted Google Fit app that you can integrate with Nexusstream.

## Create OAuth Credentials

You will need to generate a set of OAuth credentials to connect your new Google Fit app to Nexusstream properly.
...
5. Click **Add URI** and enter `https://api.khulnasoft.com/connect/oauth/oa_gA6iex/callback`

  ![Add the Nexusstream URL to the Callback Redirect URL option](https://res.cloudinary.com/dpenc2lit/image/upload/v1692295499/Screenshot_2023-08-17_at_11.04.54_AM_blco7y.png)
...
## Connect your Google Fit app Nexusstream with your Google Fit app OAuth crendentials

At this point, you should have a Google Fit App under your Google Project, and a set of OAuth keys.

1. Now when prompted in Nexusstream after trying to connect a Google Fit Developer App, copy and paste your OAuth credentials.
...
7. Click the final **Connect** and your custom Google Fit app should be integrated into Nexusstream!
