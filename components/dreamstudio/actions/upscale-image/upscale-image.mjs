...
export default {
  ...
  props: {
    ...
    image: {
      type: "string",
      label: "Image",
      description: "Image used to upscale. It can be an URL to the image or a path to the image file saved to the `/tmp` directory (e.g. `/tmp/image.png`). [see docs here](https://khulnasoft.com/docs/workflows/steps/code/nodejs/working-with-files/#the-tmp-directory).",
    },
    height: {
      propDefinition: [
