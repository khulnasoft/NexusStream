...
export default defineApp({
  ...
  propDefinitions: {
    file: {
      type: "string",
      label: "File",
      description: "File path of a file previously downloaded in Nexusstream E.g. (`/tmp/my-file.txt`). [Download a file to the `/tmp` directory](https://khulnasoft.com/docs/code/nodejs/http-requests/#download-a-file-to-the-tmp-directory)",
    },
  },
  methods: {
    getClient() {
