...
export default {
  ...
  async additionalProps() {
    ...
    if (this.inputType) {
      ...
      case "form" :
        label = "Path";
        description += "Provide the file path `/tmp/file.png`. [See the documentation](https://khulnasoft.com/docs/workflows/steps/code/nodejs/working-with-files/#the-tmp-directory).";
        break;
      }
