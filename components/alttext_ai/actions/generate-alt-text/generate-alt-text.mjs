...
export default {
  ...
  props: {
    ...
    imageFilePath: {
      ...
      description:
        "The path to an image file in the `/tmp` directory. [See the documentation on working with files](https://khulnasoft.com/docs/code/nodejs/working-with-files/#the-tmp-directory). Only one of `Image File Path`, `Image URL` or `Image Data` should be specified.",
      optional: true,
    },
    keywords: {
      type: "string[]",
