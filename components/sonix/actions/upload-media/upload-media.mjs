...
export default {
  ...
  props: {
    ...
    file: {
      type: "string",
      label: "File",
      description: "Path of the audio or video file in /tmp folder. The limit is 100MB using this parameter. For larger files, use **File URL**. `NOTE: Only one of **File** or **File URL** is required.` To upload a file to /tmp folder, please follow the [doc here](https://khulnasoft.com/docs/code/nodejs/working-with-files/#writing-a-file-to-tmp)",
      optional: true,
    },
    fileUrl: {
      type: "string",
