...
export default {
  ...
  propDefinitions: {
    sourceFile: {
      type: "string",
      label: "Source File",
      description: "The path to the file saved to the `/tmp` directory (e.g. `/tmp/image.png`). [See the documentation](https://khulnasoft.com/docs/workflows/steps/code/nodejs/working-with-files/#the-tmp-directory).",
    },
    targetFormat: {
      type: "string",
      label: "Target Format",
