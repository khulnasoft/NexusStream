...
export default {
  ...
  props: {
    ...
    destinationName: {
      ...
      description: "The destination name that will be created or updated with Nexusstream HTTP endpoint for Nexusstream source to receive your event. Existing destination with the same name will be overridden with the new HTTP endpoint",
      optional: true,
    },
  },
  hooks: {
    ...
    async activate() {
      const { id } = await this.app.createConnection({
        name: this.name || `Nexusstream_Connection_${this.getCurrentDateTime()}`,
        description: this.description,
        source_id: this.sourceId,
        source: this.source,
        destination: {
          name: this.destinationName || `Nexusstream_Source_${this.getCurrentDateTime()}`,
