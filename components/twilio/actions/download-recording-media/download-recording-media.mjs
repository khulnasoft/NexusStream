...
export default {
  ...
  props: {
    ...
    filePath: {
      type: "string",
      label: "File Path",
      description: "The destination path in [`/tmp`](https://khulnasoft.com/docs/workflows/steps/code/nodejs/working-with-files/#the-tmp-directory) for the downloaded the file (e.g., `/tmp/myFile.mp3`)",
    },
  },
  async run({ $ }) {
