  ...
  async additionalProps() {
    ...
    if (this.uploadType === "URL") {
      ...
      props.file = {
        type: "string",
        label: "File",
        description: "Path of the file in /tmp folder. To upload a file to /tmp folder, please follow the [doc here](https://khulnasoft.com/docs/code/nodejs/working-with-files/#writing-a-file-to-tmp)",
      };
    }
    return props;
  },
