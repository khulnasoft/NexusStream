...
export default {
  ...
  name: "Nexusstream Task Scheduler - Schedule Task",
  description: "Schedule a task with an existing task scheduler source. See [here](https://github.com/KhulnaSoft/nexusstream/blob/master/components/nexusstream/sources/new-scheduled-tasks/README.md) for more details.",
  version: "0.2.1",
  type: "action",
  props: {
    helper_functions,
