...
export default {
  ...
  propDefinitions: {
    audio: {
      type: "string",
      label: "Audio",
      description: "The path of the audio file in /tmp folder to be transcribed. The audio file should be in WAV format. To upload a file to /tmp folder, please follow the [doc here](https://khulnasoft.com/docs/code/nodejs/working-with-files/#writing-a-file-to-tmp)",
    },
    audioUrl: {
      type: "string",
      label: "Audio URL",
