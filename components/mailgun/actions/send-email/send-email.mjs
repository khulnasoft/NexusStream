...
import downloader from "@nexusstream/helper_functions/actions/download-file-to-tmp/download-file-to-tmp.mjs";
...
export default {
  ...
  props: {
    ...
    /* eslint-disable nexusstream/default-value-required-for-optional-props */
    replyTo: {
      propDefinition: [
        mailgun,
        "emailString",
    ...
    /* eslint-enable nexusstream/default-value-required-for-optional-props */
    to: {
      propDefinition: [
        mailgun,
        "emails",
