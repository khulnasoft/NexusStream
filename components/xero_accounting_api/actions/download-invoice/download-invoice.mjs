...
export default {
  ...
  props: {
    ...
    tenant_id: {
      type: "string",
      description: "Id of the organization tenant to use on the Xero Accounting API. See [Get Tenant Connections](https://khulnasoft.com/@sergio/xero-accounting-api-get-tenant-connections-p_OKCzOgn/edit) for a workflow example on how to pull this data.",
    },
    invoice_id: {
      type: "string",
  ...
  async run({ $ }) {
    ...
    //For an example of this action in an workflow, see: https://khulnasoft.com/@sergio/xero-accounting-api-download-invoice-p_vQCgy3o/edit
