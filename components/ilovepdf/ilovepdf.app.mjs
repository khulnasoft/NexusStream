...
export default {
  ...
  propDefinitions: {
    ...
    filePaths: {
      type: "string[]",
      label: "File Paths",
      description: "The path(s) to file(s) in the `/tmp` directory. [See the documentation on working with files](https://khulnasoft.com/docs/code/nodejs/working-with-files/#writing-a-file-to-tmp).",
      optional: true,
    },
    tool: {
      type: "string",
