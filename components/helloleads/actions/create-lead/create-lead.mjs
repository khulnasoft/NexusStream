...
export default {
  ...
  name: "Create Lead",
  version: "0.0.1",
  description: "Adds a new lead into the HelloLeads system. [See the documentation](https://github.com/KhulnaSoft/nexusstream/files/13168532/HelloLeads_CRM_API_Documentation_POST_Method.pdf)",
  type: "action",
  props: {
    helloleads,
    listKey: {
