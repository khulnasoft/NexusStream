...
export default {
  ...
  props: {
    ...
    filePath: {
      type: "string",
      label: "File Path",
      description: "The file to upload, please provide a valid file from `/tmp`. To upload a file to `/tmp` folder, please follow the doc [here](https://khulnasoft.com/docs/code/nodejs/working-with-files/#writing-a-file-to-tmp)",
    },
    type: {
      type: "string",
      label: "Type",
