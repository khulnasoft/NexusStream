...
export default {
  ...
  // eslint-disable-next-line nexusstream/source-name
  ...
  props: {
    ...
    uniqueKey: {
      type: "string",
      label: "Unique Key",
      description: "The name of a column in the table to use for deduplication. See [the docs](https://github.com/KhulnaSoft/nexusstream/tree/master/components/google_cloud/sources/bigquery-new-row#technical-details) for more info.",
