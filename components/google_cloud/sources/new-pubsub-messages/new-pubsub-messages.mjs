...
export default {
  ...
  description: "Emit new Pub/Sub topic in your GCP account. Messages published to this topic are emitted from the Nexusstream source.",
  version: "0.1.6",
  type: "source",
  ...
  async additionalProps() {
    ...
    if (this.topicType === "new") {
      topic.description = "**Nexusstream will create a Pub/Sub topic with this name in your account**, converting it to a [valid Pub/Sub topic name](https://cloud.google.com/pubsub/docs/admin#resource_names).";
