...
2. Name your integration, e.g. "Nexusstream" and choose an icon.

3. Write a short description, e.g. "This application is used to connect to the Cisco Webex (Custom App) on Nexusstream."

4. For the Redirect URI, copy and paste `https://api.khulnasoft.com/connect/oauth/oa_aWyi6o/callback`.
...
For example, if I want my application to be able to have full access to my Webex account, so that all APIs that my user can connect to can be accessed by my application on Nexusstream, I would select the scope `spark:all`. 
...
9. Copy and paste your **Client ID**, **Client Secret**, and **Space Separated Scopes** on the Cisco Webex (Custom App) account connection page on Nexusstream. 
