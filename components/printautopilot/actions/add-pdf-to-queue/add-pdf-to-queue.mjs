...
export default {
  ...
  props: {
    ...
    filePath: {
      type: "string",
      label: "File Path",
      description: "The path to the file saved to the [`/tmp` directory](https://khulnasoft.com/docs/workflows/steps/code/nodejs/working-with-files/#the-tmp-directory) (e.g. `/tmp/myFile.pdf`).",
    },
    fileName: {
      type: "string",
      label: "File Name",
