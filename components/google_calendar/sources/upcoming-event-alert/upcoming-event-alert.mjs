import taskScheduler from "../../../nexusstream/sources/new-scheduled-tasks/new-scheduled-tasks.mjs";
...
export default {
  ...
  description: `Emit new event based on a time interval before an upcoming event in the calendar. This source uses Nexusstream's Task Scheduler.
    [See the documentation](https://khulnasoft.com/docs/examples/waiting-to-execute-next-step-of-workflow/#step-1-create-a-task-scheduler-event-source) 
    for more information and instructions for connecting your Nexusstream account.`,
  version: "0.0.3",
  type: "source",
  props: {
    nexusstream: taskScheduler.props.nexusstream,
    googleCalendar,
    db: "$.service.db",
    http: "$.interface.http",
    calendarId: {
  ...
  hooks: {
    async activate() {
      ...
      // see selfSubscribe() method in nexusstream/sources/new-scheduled-tasks/new-scheduled-tasks.mjs
      await axios(this, {
