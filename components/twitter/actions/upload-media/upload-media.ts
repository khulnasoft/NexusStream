...
export default defineAction({
  ...
  props: {
    ...
    filePath: {
      type: "string",
      label: "File Path",
      description: "A file URL or a file path in the `/tmp` directory. [See the documentation on working with files.](https://khulnasoft.com/docs/code/nodejs/working-with-files/)",
      optional: false,
    },
    media_category: {
      type: "string",
