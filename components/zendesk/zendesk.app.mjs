...
export default {
  ...
  propDefinitions: {
    ...
    customSubdomain: {
      ...
      description: "For Enterprise Zendesk accounts: optionally specify the subdomain to use. This will override the subdomain that was provided when connecting your Zendesk account to Nexusstream. For example, if you Zendesk URL is https://examplehelp.zendesk.com, your subdomain is `examplehelp`",
      optional: true,
    },
  },
  methods: {
