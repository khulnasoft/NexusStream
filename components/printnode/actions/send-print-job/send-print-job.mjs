...
export default {
  ...
  props: {
    ...
    filePath: {
      type: "string",
      label: "File Path",
      description: "The path to a document file in the `/tmp` directory. [See the documentation on working with files](https://khulnasoft.com/docs/code/nodejs/working-with-files/#the-tmp-directory).",
      optional: true,
    },
    fileUrl: {
      type: "string",
