...
export default {
  ...
  props: {
    ...
    files: {
      type: "string[]",
      label: "Audio Files",
      description: "One or more `.wav` or `.mp3` filepaths in the `/tmp` directory. [See the documentation on working with files](https://khulnasoft.com/docs/code/nodejs/working-with-files/#the-tmp-directory). Max attached files: 20. Max total file size: 250 MB.",
    },
    name: {
      propDefinition: [
        lmnt,
