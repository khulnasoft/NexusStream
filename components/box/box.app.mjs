...
export default {
  ...
  propDefinitions: {
    ...
    file: {
      type: "string",
      label: "File",
      description: "The file to upload to Box, please provide a file from `/tmp`. To upload a file to `/tmp` folder, please follow the doc [here](https://khulnasoft.com/docs/code/nodejs/working-with-files/#writing-a-file-to-tmp)",
    },
    createdAt: {
      type: "string",
      label: "Created At",
