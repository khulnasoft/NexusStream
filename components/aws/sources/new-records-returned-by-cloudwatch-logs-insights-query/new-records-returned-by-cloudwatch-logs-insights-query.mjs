...
export default {
  ...
  // eslint-disable-next-line nexusstream/source-description
  ...
  props: {
    ...
    db: "$.service.db",
    // eslint-disable-next-line nexusstream/props-label
    logGroupNames: {
    ...
    emitResultsInBatch: {
      ...
      description: "If `true`, all events are emitted as an array, within a single Nexusstream event. If `false`, each row of results is emitted as its own event. Defaults to `true`",
      optional: true,
      default: true,
    },
    timer: {
