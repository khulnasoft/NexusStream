...
export default {
  ...
  description: toSingleLineString(`
    ...
    the message to this Nexusstream source, and the source emits it as a new event.
  `),
  version: "0.4.2",
  type: "source",
  ...
  methods: {
    ...
    getStateMachineDefinition() {
      ...
      return {
        Comment: `Task Scheduler for Nexusstream component ${componentId}`,
        StartAt: "Wait",
        States: {
          Wait: {
    ...
    getStateMachinePermissions() {
      ...
      const name = "publish-messages-to-nexusstream-sns-topic";
      return {
        document,
        name,
      };
