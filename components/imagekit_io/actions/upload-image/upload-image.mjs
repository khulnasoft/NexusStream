...
export default {
  ...
  props: {
    ...
    file: {
      type: "string",
      label: "File",
      description: "The file you want to upload. It can be **binnary**, **base64** or **url** or **a file path in the `/tmp` directory.** [See the documentation on working with files](https://khulnasoft.com/docs/code/nodejs/working-with-files/).",
    },
    fileName: {
      type: "string",
      label: "File Name",
