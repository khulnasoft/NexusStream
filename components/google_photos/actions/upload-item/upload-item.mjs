...
export default {
  ...
  props: {
    ...
    media: {
      type: "string",
      label: "Media Path",
      description: "The media content to upload, please provide an image file from `/tmp`. To upload a file to `/tmp` folder, please follow the doc [here](https://khulnasoft.com/docs/code/nodejs/working-with-files/#writing-a-file-to-tmp)",
    },
    filename: {
      type: "string",
      label: "File Name",
