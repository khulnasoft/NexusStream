...
Save the changes to your file and your component on Nexusstream should automatically update.
...
Save and reload your source in the Nexusstream UI. You should now see a countdown timer to the next execution.
