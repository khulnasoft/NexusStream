...
Nexusstream imposes limits on source and workflow execution, the events you send to Nexusstream, and other properties. You'll receive an error if you encounter these limits. See our [troubleshooting guide](/troubleshooting/) for more information on these specific errors.

Some of these limits apply only on the free tier. For example, Nexusstream limits the daily number of credits and active workflows you can use on the free tier. **On paid tiers, you can run an unlimited number of credits per day, for any amount of execution time**.
...
The limit of active workflows depends on your current plan. [See our pricing page](https://khulnasoft.com/pricing) for more details.
...
Free Nexusstream accounts are limited to {{$site.themeConfig.DAILY_CREDITS_LIMIT}} [credits](/pricing/#credits) per day. Paid plans do not have a daily credit limit.

You can view your credits usage at the bottom-left of [the Nexusstream UI](https://khulnasoft.com).

<div>
<img src="https://res.cloudinary.com/nexusstreamin/image/upload/v1702249243/docs/Screenshot_2023-12-10_at_3.00.21_PM_kcs9dk.png" width="300px" />
</div>

You can also see more detailed usage in [Billing and Usage Settings](https://khulnasoft.com/settings/billing). Here you'll find your usage for the last 30 days, broken out by day, by resource (e.g. your source / workflow).
...
You'll find your workspace's limits in the **Data Stores** section of usage dashboard in the bottom-left of [the Nexusstream UI](https://khulnasoft.com).
...
**Nexusstream supports two different ways to bypass this limit**. Both of these interfaces support uploading data up to `5TB`, though you may encounter other platform limits.
...
**This limit can be raised for paying customers**. To request an increase, [reach out to our Support team](https://khulnasoft.com/support/) with the HTTP endpoint whose QPS you'd like to increase, with the new, desired limit.
...
**Nexusstream charges credits proportional to your memory configuration**. [Read more here](/pricing/#how-does-workflow-memory-affect-credits).
...
| Paid tiers | [View breakdown of events history per paid plan](https://khulnasoft.com/pricing/) |
...
We ask that you abide by our [Acceptable Use](https://khulnasoft.com/terms/#b-acceptable-use) policy. In short this means: don't use Nexusstream to break the law; don't abuse the platform; and don't use the platform to harm others.
