...
thumbnail: https://res.cloudinary.com/nexusstreamin/image/upload/v1646763806/docs/icons/icons8-connected-96_fcbhxc.png
---
...
![Add your Slack account to a Python code step by adding it](https://res.cloudinary.com/nexusstreamin/image/upload/v1658954165/docs/components/CleanShot_2022-07-27_at_16.35.37_ytofp2.gif)
...
![The Slack app generates the pd.inputs["slack"] data](https://res.cloudinary.com/nexusstreamin/image/upload/v1658954351/docs/components/CleanShot_2022-07-27_at_16.38.42_f08ocy.png)

The Slack access token is generated by Nexusstream, and is available to this step in the `pd.inputs[appName]["$auth"]` object:
...
When you write custom code that connects to an app, you can start with a code snippet Nexusstream provides for each app. This is called the **test request**.
...
![Create Python API scaffolding for any app](https://res.cloudinary.com/nexusstreamin/image/upload/v1658954462/docs/components/CleanShot_2022-07-27_at_16.40.41_isy1e6.png)
...
When you want to connect to a 3rd party service that isn't supported by Nexusstream, you can store those secrets in [Environment Variables](/environment-variables/).
