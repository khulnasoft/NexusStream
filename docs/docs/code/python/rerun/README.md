...
When you trigger a job in an external service, and that service can send back data in an HTTP callback to Nexusstream, you can process that data within the same step using `pd.flow.retry`:
