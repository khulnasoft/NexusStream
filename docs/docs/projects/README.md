...
<div class="flex justify-center">
  <img src="https://res.cloudinary.com/nexusstreamin/image/upload/v1674143831/docs/New_Project_5_zep4ii.png" alt="How workspaces are organized" />
</div>
...
To create a new project, first [open the Projects section in the dashboard](https://khulnasoft.com/projects).
...
This only applies to Nexusstream accounts that created workflows before the workspaces feature was released.
...
![How to move workflows from one project to another in the Nexusstream dashboard.](https://res.cloudinary.com/nexusstreamin/image/upload/v1695662665/docs/docs/projects/CleanShot_2023-09-25_at_13.23.38_2x_dyrtlv.png)
