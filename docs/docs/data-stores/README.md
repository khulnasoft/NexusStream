...
**Data stores** are Nexusstream's built-in key-value store.
...
Nexusstream provides several pre-built actions to set, get, delete, and perform other operations with data stores.
...
![Insert a single row into a data store](https://res.cloudinary.com/nexusstreamin/image/upload/v1648060286/docs/components/CleanShot_2022-03-23_at_14.31.05_2x_swrdrh.png)
...
![Configure the action](https://res.cloudinary.com/nexusstreamin/image/upload/v1648063057/docs/components/CleanShot_2022-03-23_at_15.17.30_2x_snunyz.png)
...
![Workflow trigger example](https://res.cloudinary.com/nexusstreamin/image/upload/v1649270704/docs/components/add_update_record_action_eh7dpz.png)
...
![Create a get record action](https://res.cloudinary.com/nexusstreamin/image/upload/v1648062096/docs/components/CleanShot_2022-03-23_at_14.53.54_2x_aqpwx2.png)
...
![Get record action](https://res.cloudinary.com/nexusstreamin/image/upload/v1648853992/docs/components/data_stores_get_record_yqazfk.png)

### Deleting Data

To delete a single record from your data store, use the **Delete a single record** action in a step:

![Select the delete record step](https://res.cloudinary.com/nexusstreamin/image/upload/v1648064099/docs/components/CleanShot_2022-03-23_at_15.34.44_2x_pk9idz.png)
...
![Delete a record example](https://res.cloudinary.com/nexusstreamin/image/upload/v1648064157/docs/components/CleanShot_2022-03-23_at_15.35.48_2x_ay1bbw.png)

Deleting a record does not delete the entire data store. [To delete an entire data store, use the Nexusstream Data Stores Dashboard](#deleting-data-stores).

## Managing data stores

You can view the contents of your data stores at any time in the [Nexusstream Data Stores dashboard](https://khulnasoft.com/data-stores/). You can also add, edit, or delete data store records manually from this view.
...
![Editing a data store's value manually](https://res.cloudinary.com/nexusstreamin/image/upload/v1648063518/docs/components/CleanShot_2022-03-23_at_15.24.49_err0nt.gif)
...
![Delete a Data Store](https://res.cloudinary.com/nexusstreamin/image/upload/v1648063753/docs/components/CleanShot_2022-03-23_at_15.29.00_qtvdcz.gif)
...
<div>
<img src="https://res.cloudinary.com/nexusstreamin/image/upload/v1702248767/docs/Screenshot_2023-12-10_at_2.52.21_PM_tw2qwo.png" width="600px" />
</div>
...
Depending on your plan, Nexusstream sets limits on:
...
You'll find your workspace's limits in the **Data Stores** section of usage dashboard in the bottom-left of [https://khulnasoft.com](https://khulnasoft.com).

<div>
<img src="https://res.cloudinary.com/nexusstreamin/image/upload/v1702248992/docs/Screenshot_2023-12-10_at_2.56.28_PM_xmwqbq.png" width="300px" />
</div>
...
The following Node.js example action will export the data in chunks via an HTTP POST request. You may need to adapt the code to your needs. Click on [this link](https://khulnasoft.com/new?h=tch_egfAMv) to create a copy of the workflow in your workspace.
