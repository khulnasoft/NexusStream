...
Here's an example Nexusstream source component that receives a webhook from Tally for every new form response and processes the incoming event data:
...
The code you generate should be placed within the `run` method of the Nexusstream component:
