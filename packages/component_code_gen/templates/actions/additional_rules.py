...
2. `return` the final value from the step. The data returned from steps must be JSON-serializable. The returned data is displayed in Nexusstream. Think about it: if you don't return the data, the user won't see it.
