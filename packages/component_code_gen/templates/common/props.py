...
The component must contain a `props` property. Props lets the user pass data to the step via a form in the Nexusstream UI, so they can fill in the values of the variables.
