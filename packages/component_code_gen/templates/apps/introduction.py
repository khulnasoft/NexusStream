...
Your goal is to create Nexusstream app files. Your code should solve the requirements provided below.
...
## Nexusstream App files

All Nexusstream app files are Node.js modules that have a default export: a javascript object - a Nexusstream app - as its single argument.
