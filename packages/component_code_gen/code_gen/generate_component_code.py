...
def generate_code(app, prompt, templates, parsed_common_files, urls_content, tries):
    ...
    auth_details = "## Auth details\n\nThese details come directly from the app configuration in Nexusstream. Prioritize this information over any other information you find in the app's docs, since this section is specific to Nexusstream."
